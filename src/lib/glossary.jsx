...
const ALIAS_TO_KEY = [
  ...
  ["SLANT", "Spousal Lifetime Access Non-Grantor"],
  ["adverse party", "Adverse party"],
  ["QSST", "Qualified Subchapter S"],
  ["Qualified Subchapter S Trust", "Qualified Subchapter S"],
  ["ESBT", "Electing Small Business"],
  ["Electing Small Business Trust", "Electing Small Business"],
  ["NIMCRUT", "NIMCRUT"],
  ["Flip-CRUT", "NIMCRUT"],
